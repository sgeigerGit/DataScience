...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df['outcome']  = ["Failure", "Success"]
        fig = px.pie(filtered_df, values='class', 
        names='outcome', 
        title='Success Count For' + entered_site)
        return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        df = df[(df['Launch Site'] == entered_site) & (df['Payload Mass (kg)'] > low) & (df['Payload Mass (kg)'] < high)]
        fig = px.scatter(df, x="Payload Mass (kg)", y="class", 
        color="Booster Version Category", 
        title='Correlation Between Payload and Succes For' + entered_site)
        return fig
